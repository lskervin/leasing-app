...
export default function TenantForm({
  ...
  async function postTenant() {
    ...
    const res = await fetch("https://lease-assistant.onrender.com/tenants", config);
    if (res.ok) {
  ...
  async function updateTenant() {
    ...
    const res = await fetch(`https://lease-assistant.onrender.com/tenants/${tenant.id}`, config);
    if (res.ok) {
      onTenantRequest();
      setFormData({
        address:'',
