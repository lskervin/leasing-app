...
function App() {
    ...
    useEffect(() => {
        const fetchLeases = async () => {
            try {
                const response = await fetch('https://lease-assistant.onrender.com/leases');
                if (!response.ok) {
    ...
    useEffect(() => {
        const fetchProperties = async () => {
            try {
                const response = await fetch('https://lease-assistant.onrender.com/properties');
                if (!response.ok) {
     ...
     useEffect(() => {
      const fetchTenants = async () => {
          try {
              const response = await fetch('https://lease-assistant.onrender.com/tenants');
              if (!response.ok) {
                  throw new Error('Failed to fetch data from another endpoint');
              }
              const data = await response.json();
    ...
    useEffect(() => {
      const fetchSuites = async () => {
          try {
              const response = await fetch('https://lease-assistant.onrender.com/suites');
              if (!response.ok) {
                  throw new Error('Failed to fetch data from another endpoint');
              }
              const data = await response.json();
  ...
  useEffect(() => {
    const fetchLandlord = async () => {
        try {
            const response = await fetch('https://lease-assistant.onrender.com/landlords');
            if (!response.ok) {
                throw new Error('Failed to fetch data from another endpoint');
            }
            const data = await response.json();
   ...
   useEffect(() => {
    const fetchGuarantors= async () => {
        try {
            const response = await fetch('https://lease-assistant.onrender.com/guarantors');
            if (!response.ok) {
                throw new Error('Failed to fetch data from another endpoint');
            }
            const data = await response.json();
